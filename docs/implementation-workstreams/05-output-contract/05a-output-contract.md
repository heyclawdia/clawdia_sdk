...
[Phase 05: Output Contract](README.md)

## Parallelism

Only launch target in this phase. It must finish before validation/repair and typed-result records start in Phase 06.
...
- Implement validation, repair, or typed-result publication before Phase 06/07.
