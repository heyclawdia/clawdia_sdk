...
Parallel-safe with [Replay Recovery](10b-replay-recovery.md) and [Privacy Performance](10c-privacy-performance.md). It owns the manifest and cross-family golden audit, not the replay/privacy fixture subtrees owned by sibling targets.
...
- Own scenario output fixtures; Phase 11 owns scenario fixtures.
